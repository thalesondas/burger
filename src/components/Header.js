...
const Header = () => {
    return(
        <header fluid className="header-background d-flex flex-column justify-content-center align-items-center">
            ...
            <h1 className="mt-4 fw-bold">Rock 'n' Roll Burger</h1>
            <h2 className="mt-2 fs-3">Aqui, o sabor é o verdadeiro rockstar!</h2>
            <span className="d-block fs-6 mt-4">Rua das Avenidas 123, Jardim Headbanger, Americana - SP</span>
